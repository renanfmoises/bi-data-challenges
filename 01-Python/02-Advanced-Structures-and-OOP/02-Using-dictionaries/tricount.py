...
def final_owe(tricount, user):
    # Steps:
    # 1 - Compute total ratio of all user -> the difference between his money spent and the sum of what he owes to the other users
    # Input tricount = {'Eric': 15.0, 'Tanguy': 30.0, 'Amine': 0.0}
    # Output {'Eric': 10.0, 'Tanguy': -25.0, 'Amine': 15.0}
